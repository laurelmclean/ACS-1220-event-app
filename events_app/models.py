...
class Guest(db.Model):
    ...
    events_attending = db.relationship(
        'Events', secondary='guest_events', back_populates='guests')
...
class Event(db.Model):
    ...
    guests = db.relationship(
        'Guests', secondary='guest_events', back_populates='events_attending')
    event_type = db.Column(db.Enum(Type), default=Type.OTHER)
